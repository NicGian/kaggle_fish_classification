...
class ImageDataGenerator2(ImageDataGenerator):
    def flow(self, X, y=None, batch_size=minibatch_size, shuffle=True, seed=None,
...
def combined_model():
    ...
    x = ZeroPadding2D(padding=(1, 1), dim_ordering='default')(image)
    # Pass it through the first convolutional layer
    x = Convolution2D(2, 1, 1, input_shape=(max_img_dim, max_img_dim, 3), border_mode='same', init='he_uniform')(x)
    x = (Activation('relu'))(x)
